...
public class BookSearchServiceTest {
    ...
    @Test
    public void testSearchBookByWord() throws InterruptedException, SQLException, ExecutionException, UnsupportedEncodingException {
    ...
    private List<Book> searchBookByWord(String searchWord, String searchType)
        ...
        if (StringUtils.isBlank(searchWord) || searchWord.contains("이하나")) {
            ...
            List<Book> searchBookList = historyService.getSearchResultHistory(searchWord);
